...
<img src="media/blocks2.jpg" width=200>
...
Примечание: Устройство ждёт голосовой команды или нажатия кнопки в течение семи секунд, если пользователь ничего не делает, то устройство по истечении данного периода уходит в режим распознавания снова.
...
<img src="media/blocks3.png" width=400>
...
Устройство переходит в спящий режим после периода бездействия более 1 минуты до начала запуска режима распознавания.
